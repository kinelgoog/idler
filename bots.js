...
class SteamFarmBot {
  ...
  stopTrackingHours() { if(this.hoursInterval) clearInterval(this.hoursInterval); this.hoursInterval=null; }
  ...
  stop() {
    if(this.isRunning){ this.log('🛑 Остановка...', 'info'); this.client.logOff(); }
    this.isRunning=false; this.stopTrackingHours(); this.status='offline';
  }
